...
- 현재 게임회사 데이터 분석가 (이전경력 은행 AI, 게임회사 데이터 분석가) 
...
- Oreilly 미디어의 2017 European Data Science Salary Survey
...
- 상단 위의 File->New File->R script로 열어주셔도 되고 해당 Rmd 파일에서 실행해보셔도 됩니다.
